/* file: LowOrderMomentsSparse.java */
/*
...
public class LowOrderMomentsSparse extends Configured implements Tool {

    public static void main(String[] args) throws Exception {
        int res = ToolRunner.run(new Configuration(), new LowOrderMomentsSparse(), args);
        System.exit(res);
    }
