...
public class CovarianceSparse extends Configured implements Tool {

    public static void main(String[] args) throws Exception {
        int res = ToolRunner.run(new Configuration(), new CovarianceSparse(), args);
        System.exit(res);
    }
