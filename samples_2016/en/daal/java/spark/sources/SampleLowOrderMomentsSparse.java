/* file: SampleLowOrderMomentsSparse.java */
/*
...
public class SampleLowOrderMomentsSparse {
    public static void main(String[] args) throws IOException {
        ...
        DistributedHDFSDataSet dd = new DistributedHDFSDataSet( "/Spark/LowOrderMomentsSparse/data/", templateDataSource );
        JavaPairRDD<Integer, CSRNumericTable> dataRDD = dd.getCSRAsPairRDD(sc);

        /* Compute low order moments for dataRDD */
        SparkLowOrderMomentsSparse.MomentsResult result = SparkLowOrderMomentsSparse.runMoments(context, dataRDD);
