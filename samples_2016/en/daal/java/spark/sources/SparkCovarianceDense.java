...
public class SparkCovarianceDense {
    ...
    public static CovarianceResult runCovariance(DaalContext context, JavaPairRDD<Integer, HomogenNumericTable> dataRDD) {
    ...
    private static void computestep1Local(JavaPairRDD<Integer, HomogenNumericTable> dataRDD) {
        ...
        new PairFunction<Tuple2<Integer, HomogenNumericTable>, Integer, PartialResult>() {
            public Tuple2<Integer, PartialResult> call(Tuple2<Integer, HomogenNumericTable> tup) {
                ...
                DistributedStep1Local covarianceLocal = new DistributedStep1Local(context, Double.class, Method.defaultDense);
